    ...
    <html>
      ...
      <body>
        <div className="flex flex-col">
          <Header/>
          <div className="flex flex-col items-center w-full" style={{minHeight: 'calc(100vh - 320px)'}}>
            <div className="box-border flex flex-col items-center bg-gray-100 rounded-md flex justify-center p-5 sm:p-10 mt-10 md:px-40 sm:px-10">
              ...
              <div className="grid lg:grid-cols-3 grid-cols-2 gap-4 sm:gap-5 mt-7 cursor-pointer">
                {pokemon.map((character) => (
                  <div key={character.id} className="flex flex-col cursor-pointer items-center box-border w-32 sm:w-52 p-3 rounded-md bg-white shadow-lg">
                    <img src={character.img} className="sm:w-28 w-20"/>
